...
public class check_License
{
  public static void main(String[] args)
  {
    ...
    try
    {
      ...
      String selectStr = "SELECT * FROM RRNKCPP where NKFBCD='" + args[3] + "' and NKNSCF='" + args[4] + "' and NKFACD='" + args[0] + "' and NKFICD='" + args[1] + "' and NKFLCD='" + args[2] + "'";
      ...
      String code = ek_verschluesseln(catalog_name.trim() + args[4].trim() + args[3].trim() + valid_To.trim() + args[0].trim() + args[1].trim() + args[2].trim());
